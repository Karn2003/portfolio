    ...
    <>
      <nav className="z-50 mt-5">
        <div className="w-full">
          <div className="lg:mx-[14vw] flex max-w-5xl items-center justify-between   px-4 py-2 sm:px-6 lg:px-8">
            ...
            <div className="flex  flex-col-reverse items-end">
              <div className="sm:block lg:block">
                <ul
                  className={`lg:ml-12  lg:inline-flex  space-x-20 lg:mr-[80px] ${
                    active ? "" : "hidden"
                  }`}
                >
                  <li>
                  ...
                  <li>
                    <div
                      className={` mt-[-3px] lg:mr-[-10vw]  flex flex-row  gap-2 justify-end`}
                    >
                      <a href="https://github.com/Karn2003" target="_blank">
                        <svg
                      ...
                      <a
                        href="https://www.linkedin.com/in/karn-keraliya-1b457b219?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                        target="_blank"
                      >
                        <svg
              ...
              <div className="ml-2 sm:block lg:hidden">
